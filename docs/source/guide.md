...
This creates a SQLite database file named `database_name.db` and initializes the required tables.
...
The Classification model represents the classification results for audio samples.

| Column | Type | Description |
| --- | --- | --- |
| id | Integer | Primary key |
| sample_id | Integer | Foreign key referencing the Sample model |
| classification | String | Classification label |
| classifier | String | Name of the classifier used |
| datetime | DateTime | Timestamp of the classification |